...
#include "../include/gazebo_encoder.h"
...
namespace gazebo {
     ...
     void GazeboRosEncoder::Load(physics::ModelPtr _parent, sdf::ElementPtr _sdf){
          ...
          ROS_INFO_NAMED("sim_encoder", "Loading the encoder!!!");
          ...
          * ======================================= */
          ...
          enc_publisher_ = _nh->advertise<robot_description::EncoderData>(enc_topic_, 1);
     ...
     void GazeboRosEncoder::UpdateChild(){
          ...
          if(seconds_since_last_update > update_period_){
               ...
               enc_.id = 0;
               enc_.position = int16_t(posi * c_ppr_+ INT16_MIN);
               ...
               // ROS_INFO_NAMED("sim_encoder", "Wheel Positions [radians]: %.4f", posi);

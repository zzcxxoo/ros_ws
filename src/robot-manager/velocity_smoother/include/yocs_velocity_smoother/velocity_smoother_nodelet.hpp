...
private:
  ...
  bool                 input_active;
  bool            stop_input_active;
  double                cb_avg_time;
  double           stop_cb_avg_time;
  ros::Time            last_cb_time;
  ros::Time       last_stop_cb_time;
  std::vector<double> period_record; /**< Historic of latest periods between velocity commands */
  std::vector<double> stop_period_record; /**< Historic of latest periods between velocity commands */
  unsigned int              pr_next; /**< Next position to fill in the periods record buffer */
  unsigned int         stop_pr_next; /**< Next position to fill in the periods record buffer */
  ...
  ros::Subscriber stop_vel_sub;  /**< Stop immediately velocity commands */
  ...
  void stopvelocityCB(const geometry_msgs::Twist::ConstPtr& msg);
